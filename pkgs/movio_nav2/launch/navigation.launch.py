...
def generate_launch_description():
    ...
    movio_description_path = get_package_share_directory('movio_description')
    ...
    rviz_config_path = os.path.join(movio_description_path, 'rviz', 'movio_config.rviz')
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        'map',
        default_value=os.path.join(movio_nav2_dir, 'maps', 'food_court.yaml'),
    ...
    declare_mapper_online_async_param_cmd = DeclareLaunchArgument(
        'async_param',
        default_value=os.path.join(movio_nav2_dir, 'config', 'mapper_params_online_async.yaml'),
    ...
    declare_rviz_config_file_cmd = DeclareLaunchArgument(
        'rviz_config',
        default_value=os.path.join(movio_nav2_dir, 'params', 'tb3.rviz'),
